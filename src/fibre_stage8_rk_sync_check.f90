program fibre_stage8_rk_sync_check
  ...
  call apply_stage8_controlled_rk_substep_coupling(gbridge,layout,ux,uy,uz,beta,sblk,fx,fy,fz,st_blocked,1,ok,rej); call compute_stage8_force_density_norm(fx,fy,fz,bnrm); blk=merge(1,0,rej==1.and.bnrm<=1e-14_mytype)
