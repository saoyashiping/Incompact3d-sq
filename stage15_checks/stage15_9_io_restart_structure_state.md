...
Do not pass the much tighter Stage 15.7 diagnostic RHS-response tolerance into Stage 14.9 as `STAGE14_9_MAX_RHS_INCREMENT`; doing so falsely fails valid Stage 14.9 small-lambda production I/O evidence.
