program fibre_prod_p1_np_consistency_closure_case_check
  ...
  call p1_4_np_compare_signatures(sig2, sig2, status); if (status /= 0) error stop 3
  ux(2,2,2)=ieee_value(ux(2,2,2), ieee_quiet_nan)
  call p1_4_np_init_values(1,49,1.0e-4_real64,2.0_real64,0.10_real64, &
       1.0e-2_real64,1.0e2_real64,1.0e2_real64,1.0e6_real64,status); if (status /= 0) error stop 4
  call p1_4_np_record_sampling(ux,uy,uz,status); if (status == 0) error stop 5
  ux=1.0_real64
  call p1_4_np_set_sample_for_check(ieee_value(ux(1,1,1), ieee_quiet_nan),0.0_real64,0.0_real64)
  call p1_4_np_record_structure_response(status); if (status == 0) error stop 6
  call p1_4_np_init_values(1,49,1.0e-4_real64,2.0_real64,0.60_real64, &
       1.0e-2_real64,1.0e2_real64,1.0e2_real64,1.0e6_real64,status); if (status == 0) error stop 7
  call p1_4_np_init_values(2,49,1.0e-4_real64,2.0_real64,0.10_real64, &
       1.0e-2_real64,1.0e2_real64,1.0e2_real64,1.0e6_real64,status); if (status == 0) error stop 8
  call p1_4_np_init_values(1,48,1.0e-4_real64,2.0_real64,0.10_real64, &
  ...
  call p1_4_np_record_force_buffer(status); if (status == 0) error stop 11
...
contains
  subroutine run_case(lambda, rx, ry, rz, sig, status)
    ...
    call p1_4_np_init_values(1,49,lambda,2.0_real64,0.10_real64, &
         1.0e-2_real64,1.0e2_real64,1.0e2_real64,1.0e6_real64,status); if (status /= 0) return
    call p1_4_np_record_sampling(ux,uy,uz,status); if (status /= 0) return
    call p1_4_np_record_structure_response(status); if (status /= 0) return
    call p1_4_np_record_reaction_force(status); if (status /= 0) return
    call p1_4_np_record_force_buffer(status); if (status /= 0) return
    call p1_4_np_record_rhs_increment(rx,ry,rz,status); if (status /= 0) return
    call p1_4_np_record_global_signatures(status); if (status /= 0) return
    call p1_4_np_write_diagnostics(status); if (status /= 0) return
