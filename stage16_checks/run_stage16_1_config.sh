...
STAGE16_1_ACCEPT_STAGE16_0_CLOSED_EVIDENCE=${STAGE16_1_ACCEPT_STAGE16_0_CLOSED_EVIDENCE:-1}
...
python3 stage16_checks/assert_stage16_1_config.py \
    ...
    --accept-stage16-0-closed-evidence "$STAGE16_1_ACCEPT_STAGE16_0_CLOSED_EVIDENCE" \
