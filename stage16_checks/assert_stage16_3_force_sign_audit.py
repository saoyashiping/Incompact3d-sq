...
def main() -> int:
    ...
    if args.require_stage16_2 == "1":
        ...
        stage16_2_files_ok = all(path.exists() for path in stage16_2_files)
        if stage16_2.get("final_status") != "1" and not (args.accept_stage16_2_closed_evidence == "1" and stage16_2_files_ok):
