...
STAGE16_2_ACCEPT_STAGE16_1_CLOSED_EVIDENCE=${STAGE16_2_ACCEPT_STAGE16_1_CLOSED_EVIDENCE:-1}
...
python3 stage16_checks/assert_stage16_2_one_fibre_case_definition.py \
    ...
    --accept-stage16-1-closed-evidence "$STAGE16_2_ACCEPT_STAGE16_1_CLOSED_EVIDENCE" \
