...
def need(k):
    ...
    return vals[k]
expected_one=['stage7_grid_stage6_closed_marker_status','stage7_grid_stage7_0_dependency_status','stage7_grid_x_uniform_flag','stage7_grid_z_uniform_flag','stage7_grid_periodic_x_flag','stage7_grid_periodic_z_flag','stage7_grid_y_nonuniform_flag','stage7_grid_y_monotonic_flag','stage7_grid_dy_min_positive_flag','stage7_grid_volume_positive_flag','stage7_grid_ymin_correct_flag','stage7_grid_ymax_correct_flag','stage7_grid_wall_bounds_status','stage7_grid_uniform_y_detected_flag','stage7_grid_invalid_size_rejected_flag','stage7_grid_invalid_dy_rejected_flag','stage7_grid_invalid_boundary_rejected_flag','stage7_grid_dy_face_consistency_status','stage7_grid_volume_formula_status','stage7_grid_metadata_check_status']
