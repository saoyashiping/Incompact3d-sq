...
program xcompact3d
  ...
  ! Stage 9.8 begin is performed inside init_xcompact3d after reading the input file.
  ! Reinitialising here would erase restart-read diagnostics captured during init.
